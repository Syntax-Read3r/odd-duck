...
if (localStorage.getItem("allProds") === null) {
  ...
  console.log('local storage found');
	let allProdsInStorage = JSON.parse(localStorage.getItem("allProds"));
  for(let x in allProdsInStorage) {
    console.log(allProdsInStorage[x])
		let tempPro = new ProductImages(arr[x], `./images/assets/${arr[x]}.jpg`);
    console.log(tempPro.clickAcc)
    tempPro.clickAcc = allProdsInStorage[x].clickAcc;
    tempPro.views = allProdsInStorage[x].views;
  }
}
...
function getResults() {
	localStorage.setItem("allProds", JSON.stringify(allProds));
